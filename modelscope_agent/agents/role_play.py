    ...
    def _run(self,
        ...
        while True and max_turn > 0:
            ...
            if self.llm.support_function_calling():
                print(f"at {10 - max_turn},self.llm.support_function_calling() == True")
                ...
                print(f"at {10 - max_turn},self.llm.support_function_calling() == False")
            ...
            if use_tool:
                if self.llm.support_function_calling():
                    print(f"at {10 - max_turn},use tools !!! self.llm.support_function_calling() == True")
